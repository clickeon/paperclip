...
export const help: Record<string, string> = {
  ...
  wakeOnDemand: "Allow this agent to be woken by assignments, API calls, UI actions, or automated systems. Master gate — disabling this blocks all non-timer wake sources.",
  wakeOnComment: "Wake when another agent posts a comment on an issue this agent is watching. Disable to reduce noise from agent-to-agent chatter.",
  wakeOnUserComment: "Wake when a human user posts a comment on an issue assigned to this agent. @-mentions always wake regardless of this setting.",
